...
function send_student_otp_email(array $student, string $otp, int $expiresMinutes): bool
{
    $subject = 'Your RFID Student Account OTP';
    $name = trim($student['first_name'] . ' ' . $student['last_name']);

    $message = "<p>Hello <strong>" . htmlspecialchars($name, ENT_QUOTES, 'UTF-8') . "</strong>,</p>" .
    ...
    return send_system_email($student['email'], $name, $subject, build_email_template('OTP Verification Code', $message, 'If you did not request this code, please contact your administrator.'));
}
