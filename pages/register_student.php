...
<script>
// RFID input handling - simulate keyboard input
document.addEventListener('DOMContentLoaded', function() {
    ...
    // Handle RFID scanning (simulated by keyboard input)
    let rfidBuffer = '';
    ...
    document.addEventListener('keydown', function(e) {
        ...
        // If more than 100ms since last key, clear buffer
        ...
        if (e.key.length === 1 && e.key.match(/[a-zA-Z0-9]/)) {
            ...
            // If buffer is long enough (typical RFID UID length), set value
